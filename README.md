...
- [배경](#배경) — 문제, Route Server의 가치, 적용 환경, 아키텍처 개요
- [GRE 오버레이 연결 플로우](#gre-오버레이-연결-플로우)
- [1. 설정 순서](#1-설정-순서)
- [2. CloudFormation 배포 자원](#2-cloudformation-배포-자원)
- [3. 검증 가이드](#3-검증-가이드)
- [4. Failover 테스트](#4-failover-테스트) — 실측 결과
